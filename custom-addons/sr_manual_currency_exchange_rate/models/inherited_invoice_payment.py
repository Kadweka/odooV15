...
class AccountPayments(models.Model):
    ...
    def onchange_destination_journal(self):
        if self.destination_journal_id:
            if self.destination_journal_id.currency_id and self.company_id.currency_id != self.destination_journal_id.currency_id:
                self.active_manual_currency_rate = True
            else:
                self.active_manual_currency_rate = False
        else:
                ...
                if payment.destination_journal_id.currency_id:
                    if self.active_manual_currency_rate:
                        ...
                        if self.apply_manual_currency_exchange:
                            ...
                            transfer_amount = payment.amount / payment.manual_currency_exchange_rate
                            print ("====2222222222222222222",transfer_amount)
                        else:
